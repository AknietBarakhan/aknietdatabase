...
-- Tom Brown excluded (dept_id = NULL)
...
-- Tom Brown shows NULL dept info
...
-- NULL left: departments w/o employees
-- NULL right: employees w/o departments
...
-- Difference:
-- ON → keeps all employees, only match Building A depts
-- WHERE → filters out non-Building A employees
